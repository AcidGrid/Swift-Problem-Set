 ...
 */
func beginsWithVowel(inputString: String) -> Bool /* define the return type */ {
    /* add function implementation here */
    if(inputString == "")
    {
        return false
    }else if inputString.lowercased().characters[inputString.startIndex] == "a"{
        return true
    }else if inputString.lowercased().characters[inputString.startIndex] == "e"{
        return true
    }else if inputString.lowercased().characters[inputString.startIndex] == "i"{
        return true
    }else if inputString.lowercased().characters[inputString.startIndex] == "o"{
        return true
    }else if inputString.lowercased().characters[inputString.startIndex] == "u"{
        return true
    }else{
        return false
    }
 ...
 */
func funWithWords(inputString: String) -> String /* define the return type */ {
    /* add function implementation here */
    if(inputString == "")
    {
        return ""
 ...
 funWithWords(inputString: "Apples") // "APPLES"
 funWithWords(inputString: "pIG") // "pig"
 funWithWords(inputString: "oink") // "OINK"
 funWithWords(inputString: "udacity") // "UDACITY"
 funWithWords(inputString: "") // ""
